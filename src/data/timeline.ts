export const TIMELINE_LIST = [
  ...
  },
  {
    colorCode: '#2E8B57',
    year: '大学院',
    title: '自然っぽさ/人工っぽさという指標で、画像と音楽を対応づける研究(大学院)',
  ...
  },
  {
    colorCode: '#FF570D',
    year: 'WEBアプリ開発',
    title: 'AIアプリのフロントエンドメインのフルスタック実装',
    process: 'フロントメイン、時々バック / 画面設計、概要設計、詳細設計、実装、テスト作成',
    text: 'AI関連のWebアプリサービス。半年ほどtoCアプリを作成し、その後はtoBアプリを作成。フロントエンドを主軸に、デザイン・バックエンド・インフラなど幅広く実施。',
    tech: 'Vue.js / Nuxt.js / Python / Flask / Figma'
  },
  {
    colorCode: '#136FFF',
    year: 'WEBアプリ開発',
    title: '教育メディアのフロントエンド実装 & 社内ツール設計',
    process: 'フロントエンド / 技術選定、詳細設計、実装、テスト作成',
    text: '教育メディアをフロントエンドのVue.js化、既存画面の機能追加、社内ツールの設計などを実施。',
  ...
  },
  {
    ...
    text: '医療系サービスの管理システムの画面設計とフロントエンド実装、顧客対応チーム用ツールの作成などを実施',
    tech: 'React / AWS Amplify / Slack API(Bolt Kit) / Figma'
  }
]
